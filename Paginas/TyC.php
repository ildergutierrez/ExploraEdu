    ...
    <style>
      /* Elimina los márgenes predeterminados de body y html */
      body,
      html {
        margin: 0;
        padding: 0;
          ...
          <div class="modal-dialog">
            ...
            <div class="container" style="text-align: justify; padding: 80px; text-align: 1 em;">
              <<center>
                ...
                <br /><br><br>
                1. Aceptación de los términos: Al registrarse en <b>Explora Edu</b>, el usuario
                acepta automáticamente los siguientes términos y condiciones. Si el
                usuario no está de acuerdo con alguno de estos términos, no deberá
                utilizar la plataforma. <br />

                <br> 2. Uso adecuado: El usuario se compromete a utilizar <b>Explora Edu</b> de
                manera adecuada y conforme a la ley. Esto incluye el respeto a los
                derechos de propiedad intelectual, la no realización de actividades
                ilegales o fraudulentas, y el cumplimiento de todas las políticas y
                directrices establecidas por <b>Explora Edu</b>. <br>
                <br> 3. Responsabilidad del usuario:
                El usuario es responsable de mantener la confidencialidad de su
                contraseña y de toda actividad que ocurra bajo su cuenta. <b>Explora Edu</b> no
                se hace responsable de ninguna pérdida o daño resultante del acceso no
                autorizado a la cuenta del usuario.
                <br> 4. Privacidad: <b>Explora Edu</b> respeta la
                privacidad del usuario y se compromete a proteger sus datos personales
                de acuerdo con nuestra política de privacidad. El usuario acepta que
                <b>Explora Edu</b> pueda utilizar sus datos personales de acuerdo con esta
                política. <br>
                <br> 5. Modificaciones: <b>Explora Edu</b> se reserva el derecho de
                modificar estos términos y condiciones en cualquier momento y sin previo
                aviso. Se recomienda al usuario revisar periódicamente estos términos
                para estar al tanto de cualquier cambio. <br>

                <br><br> <i>Al registrarse en <b>Explora Edu</b>,
                  el usuario reconoce haber leído, entendido y aceptado estos términos y
                  condiciones en su totalidad. Si el usuario tiene alguna pregunta o
                  inquietud sobre estos términos, puede ponerse en contacto con nosotros a
                  través de los medios proporcionados en la plataforma.</i>
                <br><br>
