    ...
    <main>
      <div class="container" style="padding: 10px; padding-top: 0; background-color: #f8f8ff">
        ...
        <div class="container" style="text-align: justify; padding: 80px; text-align: 1 em;">
          ...
          <br />
          &ensp; Nuestra visión en <strong>Explora Edu</strong> es ser líderes
          reconocidos a nivel nacional en la promoción de la educación
          experiencial y el turismo educativo, siendo la plataforma preferida
          por centros educativos y universidades para la planificación de viajes
          educativos en Colombia. Nos comprometemos a seguir innovando y
          expandiendo nuestra oferta de destinos y recursos educativos,
          colaborando estrechamente con instituciones académicas, empresas y
          organizaciones locales para ofrecer experiencias únicas y
          enriquecedoras que impulsen el aprendizaje, la creatividad y el
          desarrollo integral de la comunidad educativa. <br /><br />
        </div>
    </main>
