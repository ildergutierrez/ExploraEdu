    ...
    <main>
      <div class="container" style="padding: 10px; padding-top: 0; background-color: #f8f8ff">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="../php/sesion.php" method="post">
                  <div class="mb-3">
                  <input type="hidden" value="../Paginas/mision.php" name="link">
        ...
        <div class="container" style="text-align: justify; padding: 80px; line-height: 2em;">
          ...
          <br />
          &ensp; En <strong>Explora Edu</strong>, nuestra misión es ser el
          catalizador de experiencias educativas transformadoras, conectando a
          centros educativos y universidades con destinos inspiradores en las
          regiones de Colombia. Nos comprometemos a proporcionar una plataforma
          integral que facilite la planificación y organización de visitas
          científicas y empresariales, promoviendo el aprendizaje práctico, la
          exploración activa y el crecimiento personal de estudiantes y
          educadores. Nos esforzamos por ampliar los horizontes de la educación
          tradicional, ofreciendo oportunidades innovadoras y significativas que
          inspiren el descubrimiento, la curiosidad y el desarrollo de
          habilidades del siglo XXI.<br /><br />
        </div>
    </main>
