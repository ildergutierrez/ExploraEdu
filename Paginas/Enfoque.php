...
<head>
  ...
  <title>Enfoque Diferencial</title>
  ...
  <div class="container-fluid" style="padding: 0">
    ...
    <main>
      <div class="container" style="padding: 10px; padding-top: 0; background-color: #f8f8ff">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form action="../php/sesion.php" method="post">
                  <div class="mb-3">
                    <input type="hidden" value="../Paginas/Enfoque.php" name="link">
        ...
        <div class="container" style="text-align: justify; padding: 80px; line-height: 2em;">
          <center>
            <br><br>
            <h1>Enfoque Diferencial</h1>
          </center> <br><br>
          &ensp; El factor diferencial de <strong>Explora Edu</strong> radica en
          su enfoque integral y altamente personalizado en la organización de
          viajes educativos y expediciones de campo. A diferencia de otras
          plataformas similares que se centran únicamente en la reserva de
          alojamiento o transporte, <strong>Explora Edu</strong> ofrece una
          solución completa que abarca desde la selección de destinos hasta la
          coordinación logística y la provisión de recursos educativos. Nuestra
          plataforma se destaca por su capacidad para adaptar cada
          <em>viaje</em> a las necesidades específicas de cada grupo educativo,
          brindando herramientas avanzadas de <em>planificación</em> y gestión
          que permiten crear itinerarios personalizados y seleccionar
          actividades relevantes de manera eficiente. <br /><br />
          &ensp;Además, <strong>Explora Edu</strong> va más allá de ser
          simplemente una herramienta de reserva de <em>viajes</em>, ofreciendo
          una variedad de recursos educativos y experiencias enriquecedoras
          diseñadas para complementar y mejorar el
          <em>aprendizaje fuera del aula</em>. Desde guías educativas hasta
          materiales de <em>estudio interactivos</em>, nuestra plataforma
          proporciona acceso a una amplia gama de recursos que enriquecen la
          experiencia educativa y promueven el aprendizaje práctico y
          significativo. Con ExploraEdu, los usuarios pueden disfrutar de una
          experiencia educativa única y transformadora que va más allá de lo
          convencional, inspirando, educando y empoderando a estudiantes y
          educadores por igual. <br /><br />
        </div>
    </main>
