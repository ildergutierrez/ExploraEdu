        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="recomendaciones usuario.php">Recursos Educativos</a>
              </li>
              <li class="nav-item">
    ...
    <main>
      <div class="container" style="padding: 10px; padding-top: 0; background-color: #f8f8ff">
        ...
        <div class="container" style="text-align: justify; padding: 80px; text-align: 1 em;">
          ...
          <ol>
            <li>
              Excelencia: Nos comprometemos a ofrecer servicios de la más alta
              calidad, superando las expectativas de nuestros clientes y
              promoviendo la excelencia en todo lo que hacemos.
            </li>
            <li>
              Innovación: Buscamos constantemente nuevas formas de mejorar y
              enriquecer la experiencia educativa, adoptando tecnologías y
              prácticas innovadoras que impulsen el cambio y la mejora continua.
            </li>
            <li>
              Colaboración: Valoramos la colaboración y el trabajo en equipo,
              creando alianzas estratégicas con instituciones educativas,
              empresas y organizaciones locales para maximizar el impacto de
              nuestras iniciativas.
            </li>
            <li>
              Integridad: Actuamos con honestidad, transparencia y ética en
              todas nuestras relaciones y operaciones, manteniendo la confianza
              y el respeto de nuestros clientes, socios y comunidad.
            </li>
            <li>
              Compromiso con la educación: Estamos comprometidos con la
              promoción de la educación como motor de cambio y desarrollo
              social, ofreciendo oportunidades de aprendizaje significativas y
              accesibles para todos.
            </li>
            <li>
              Responsabilidad social y ambiental: Nos preocupamos por el
              bienestar de nuestra comunidad y el medio ambiente, adoptando
              prácticas sostenibles y responsables en todas nuestras actividades
              y operaciones.
            </li>
            <li>
              Pasión por el aprendizaje: Nos apasiona el proceso de aprendizaje
              y la búsqueda del conocimiento, cultivando un ambiente de
              curiosidad, creatividad y crecimiento personal en todo lo que
              hacemos.
            </li>
          </ol>
          Estos valores guiarán nuestras acciones y decisiones en
          <strong>Explora Edu</strong>, ayudándonos a cumplir nuestra misión y
          alcanzar nuestra visión de manera ética y responsable. <br /><br />
