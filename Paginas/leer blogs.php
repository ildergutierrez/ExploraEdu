    ...
    <div class="container-fluid" style="padding: 0">
        ...
        <main>
            <div class="container" style="padding: 10px; padding-top: 0; background-color: #f8f8ff">
                <!-- Boton flotante -->
                <a href="blogs.php"><button class="btn btn-primary floating-button" title="Volver"><img src="../imagen/anterior.png" width="20px" alt="Atras"></button></a>
                <!-- fin del boton  -->
                ...
                ?>
                        ...
                        <div class="row" style="overflow: hidden; margin: auto; height: 25em;">
                            ...
                            <div class="col-md-8 d-flex justify-content-center align-items-center">
                                <img src="<?php echo $ruta ?>" alt="Puhs" style="width: 90%;  border-radius: 20px;">
                            </div>
                            <div class="col-md-2"></div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div>
                                    ...
                                    <div class="container">
                                        <?php echo "<div>"; ?>
                                        <label for="" style="border-radius: 15px; background: #C7E1DF; text-align: justify; padding: 10px;" class="form-label">
                                            <center>
                                                <h2><?php echo $fila['Titulo'] ?></h2> <br><br>
                                            </center>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <p style="padding: 20px;"><b>Fecha: </b><?php echo $fila['Fecha'] ?> <br>
                                    <b>Autor: </b><?php echo $fila['Autor'] ?>
                                </p>
                            </div>
                            <div class="col-2">
