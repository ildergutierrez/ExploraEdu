...
$consulta = "SELECT * FROM recomendaciones WHERE id='$datos_decodificados'";
$resultado = $conexion->query($consulta);
if ($resultado) {

    if ($resultado->num_rows > 0) {
        $fila = $resultado->fetch_assoc();
        $qerry = "UPDATE `recomendaciones` SET `Visto`='si' WHERE  `id`=$datos_decodificados";
        $ejecutar = mysqli_query($conexion, $qerry);
        $conexion->close();
    } else {
        header("Location: N_Recomendacion");
    }
}
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="modal fade modal-xl" id="imagenModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            <div class="row" style="padding-top: 20px; color: #000; background-color: rgba(238, 238, 238, 0.8); border-radius: 15px;">
                                <div class="col-1" style="padding-bottom:15px; "><a href="N_Recomendacion.php"><img src="../imagenes/anterior.png" alt="volver" width="50%"></a></div>
                                ...
                                <div class="col-3" style="text-align: center; font-size: 12px;">
                                    <div class="row">
                                        ...
                                        <div class="col"><a href="../php/Elimira_Nuevas.php?accion=Recomendacion&acceso=<?php echo $datos_decodificados ?>"> <img src="../imagenes/Basura.png" alt="Eliminar" title="Elimnar" width="35%" style="float: left;"></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row" style="padding-top: 20px; color: #000; background-color: rgba(238, 238, 238, 0.8); border-radius: 15px;">
                                <div class="col-12" style="text-align: justify;">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <?php
                                            $foto = "../../recomendaciones/" . $fila['Imagen'];
                                            echo "<div class='row'>";
                                            echo "<br> <br> <br> <br><br> <br> <div class='col-4'>";
                                            echo "<center> <img src='$foto' class='imagen-modal' width='100%' alt='...' data-toggle='modal' data-target='#imagenModal' data-imagen='$foto'></center>";
                                            echo "</div>";
                                            ?>
                                            <br> <br>
                                            <div class="container">
